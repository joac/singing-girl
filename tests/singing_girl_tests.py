...
class TestTraductorNumeros(unittest.TestCase):
    ...
    def test_numeros_grandes(self):
        ...
        self.assertSing(416010015,
                        'cuatrocientos dieciseis millones diez mil quince')
        self.assertSing(
            1123123123123123123123123123123123456123456,
            'un millon ciento veintitres mil ciento veintitres billones '
            'ciento veintitres mil ciento veintitres millones ciento '
            'veintitres mil ciento veintitres trillones ciento veintitres mil '
            'ciento veintitres millones ciento veintitres mil ciento '
            'veintitres billones ciento veintitres mil cuatrocientos '
            'cincuenta y seis millones ciento veintitres mil cuatrocientos '
            'cincuenta y seis'
        )
